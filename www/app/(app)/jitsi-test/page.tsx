...
export default function JitsiTestPage(): JSX.Element {
  ...
  if (meetingState === "ready" && meetingConfig && jwtToken) {
    return (
      <Box width="100vw" height="100vh" position="relative">
        ...
        >
          <VStack align="start" spacing={2}>
            ...
            <HStack>
              <Text fontSize="sm">
                Room: <strong>{meetingConfig.roomName}</strong>
              </Text>
        ...
        <JitsiMeetSDK
          ...
          startWithAudioMuted={meetingConfig.startWithAudioMuted}
          startWithVideoMuted={meetingConfig.startWithVideoMuted}
        ...
        {meetingState === "error" && (
          ...
          >
            <VStack spacing={3}>
              ...
              <Button onClick={() => setMeetingState("idle")}>Try Again</Button>
            </VStack>
          </Box>
        )}
      </VStack>
