...
class TestGenerateSnippets:
    ...
    def test_multiple_matches(self):
        ...
        text = (
            "Python is great for machine learning." + separator +
            "Many companies use Python for data science." + separator +
            "Python has excellent libraries for analysis." + separator +
    ...
    def test_single_match(self):
        ...
        snippets = TranscriptController._generate_snippets(text, "artificial intelligence")
    ...
    def test_case_insensitive_search(self):
        ...
        text = ("MACHINE LEARNING is important for modern applications. " + 
    ...
    def test_max_snippets_limit(self):
        ...
        snippets_1 = TranscriptController._generate_snippets(text, "Python", max_snippets=1)
        assert len(snippets_1) == 1
        
        snippets_2 = TranscriptController._generate_snippets(text, "Python", max_snippets=2)
        assert len(snippets_2) == 2
        
        snippets_5 = TranscriptController._generate_snippets(text, "Python", max_snippets=5)
...
00:00:10.000 --> 00:00:20.000
<v Speaker1>""" + "Various industries are adopting new technologies. " * 10 + """

00:00:20.000 --> 00:00:30.000
<v Speaker2>Machine learning is revolutionizing healthcare and diagnostics.

00:00:30.000 --> 00:00:40.000
<v Speaker3>""" + "Financial markets show interesting patterns. " * 10 + """
...
"""
        ...
        snippets = TranscriptController._generate_snippets(plain_text, "machine learning")
