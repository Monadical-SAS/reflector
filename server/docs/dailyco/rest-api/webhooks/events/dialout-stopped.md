# Source: https://docs.daily.co/reference/rest-api/webhooks/events/dialout-stopped

# Dialout stopped

Emitted when the session with the remote party is stopped, typically, by the initiator. These can be activated via [`stopDialOut()`](/reference/daily-js/instance-methods/stop-dial-out) or via the [REST API](/reference/rest-api/rooms/dialOut/stop).
...
[Previous](/reference/rest-api/webhooks/events/dialout-answered)

[Next](/reference/rest-api/webhooks/events/dialout-error)
