# Source: https://docs.daily.co/reference/rest-api/webhooks/events/streaming-updated

# Streaming Updated

A streaming updated event emits when the call live stream was updated. These can be activated via [`updateLiveStreaming()`](/reference/daily-js/instance-methods/update-live-streaming) or via the [REST API](/reference/rest-api/rooms/live-streaming/update).
...
[Previous](/reference/rest-api/webhooks/events/streaming-started)

[Next](/reference/rest-api/webhooks/events/streaming-ended)
