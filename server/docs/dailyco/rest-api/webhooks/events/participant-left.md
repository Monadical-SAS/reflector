# Source: https://docs.daily.co/reference/rest-api/webhooks/events/participant-left
...
[Previous](/reference/rest-api/webhooks/events/participant-joined)

[Next](/reference/rest-api/webhooks/events/waiting-participant-joined)
