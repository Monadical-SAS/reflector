# Source: https://docs.daily.co/reference/rest-api/webhooks/events/dialout-connected

# Dialout connected

Emitted when the session with the remote end is established, i.e., the initiator will hear the call ringing. These can be activated via [`startDialOut()`](/reference/daily-js/instance-methods/start-dial-out) or via the [REST API](/reference/rest-api/rooms/dialOut/start).
...
[Previous](/reference/rest-api/webhooks/events/batch-processor-error)

[Next](/reference/rest-api/webhooks/events/dialout-answered)
