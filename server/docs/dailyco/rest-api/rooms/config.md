# Source: https://docs.daily.co/reference/rest-api/rooms/config
...
**More resources on room privacy**
  ...
  * [An introduction to room access control](https://www.daily.co/blog/intro-to-room-access-control/)
...
Most properties determine what features appear when using [the Daily prebuilt UI](/prebuilt).
...
[Next](/reference/rest-api/rooms/list-rooms)
