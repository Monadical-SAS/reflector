# Source: https://docs.daily.co/reference/rest-api/rooms/live-streaming/update
...
Updates a live stream at the `rtmpUrl` specified.
...
Cannot accept both `rtmpURL` and `endpoints` at the same time. Use `endpoints` when you want to update both RTMP and HLS.
...
[Previous](/reference/rest-api/rooms/live-streaming/start)

[Next](/reference/rest-api/rooms/live-streaming/stop)
