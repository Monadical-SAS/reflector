# Source: https://docs.daily.co/reference/rest-api/your-domain/set-domain-config
...
**A`POST` request to `/` sets top-level [configuration options for your domain](/reference/rest-api/your-domain/config).**

The request returns a domain object on success. On failure, it returns an [HTTP error](/reference/rest-api#errors).
...
[Previous](/reference/rest-api/your-domain/get-domain-config)
