# Source: https://docs.daily.co/reference/rest-api/batch-processor/reference/delete-job
...
Objects stored in a custom bucket are not deleted. The API response is the same as [Get job status](/private/batch-processor/reference/get-job). The `output` key in the response provides enough information to delete any object stored in the custom bucket.
...
[Previous](/reference/rest-api/batch-processor/reference/list-jobs)
